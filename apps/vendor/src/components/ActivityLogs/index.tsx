...
const ActivityLogs: React.FC<ActivityPropsT> = ({ open, setOpen }) => {
  return (
    <div>
      <div
        className={`min-h-[100%] ${
          open
            ...
            : "w-0 opacity-0"
        } absolute right-0 top-0 z-50 bg-white transition-all delay-100 duration-500`}
      >
        <div className='p-4 3xl:p-5 flex items-center justify-between'>
          <div className='text-content-primary text-xl font-normal'>
            Activity Logs
          </div>
